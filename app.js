...
var formSubmitHandler = function (event) {
    ...
    if (cityname) {
        ...
        alert("Please choose a city to check");
    }

}

// Pull weather data from openwathermap
var getWeatherInfo = function (cityname) {
    ...
    fetch(
        // fetch the url with given api key
        apiCityUrl
    )
        ...
        .then(function (cityResponse) {
            ...
            return fetch('https://api.openweathermap.org/data/2.5/onecall?lat=' + latitude + '&lon=' + longitude + '&exclude=alerts,minutely,hourly&units=imperial&appid=e4472e63c5e342060f55f3f62a8d6b91');
        })
